...
export function errorResponse(error: unknown): Response {
    ...
    const known: Record<string, [number, string]> = {
        ...
        USUARIO_ALVO_INVALIDO: [400, 'USUARIO_ALVO_INVALIDO'],
        NIVEL_BLOQUEIO_INVALIDO: [400, 'NIVEL_BLOQUEIO_INVALIDO'],
        TIPO_BLOQUEIO_INVALIDO: [400, 'TIPO_BLOQUEIO_INVALIDO'],
        ESTADO_BLOQUEIO_INVALIDO: [400, 'ESTADO_BLOQUEIO_INVALIDO'],
        BLOQUEIO_INVALIDO: [400, 'BLOQUEIO_INVALIDO'],
        USUARIO_ALVO_NAO_ENCONTRADO: [404, 'USUARIO_ALVO_NAO_ENCONTRADO'],
    };
