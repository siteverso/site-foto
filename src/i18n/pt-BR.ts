export default {
  ...
  home: {
    ...
    deletePhoto: 'Apagar esta foto?', loadMore: 'Carregar mais', loadingMore: 'Carregando…', viewProfile: 'Ver perfil de', post: 'Postar', newPost: 'Publicar imagem', fullscreenPhoto: 'Tela cheia', previousPhoto: 'Foto anterior', nextPhoto: 'Próxima foto', editCaption: 'Editar legenda',
