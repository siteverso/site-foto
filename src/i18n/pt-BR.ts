export default {
  ...
  profile: {
    ...
    hiddenObservedHelp: 'Escolha, entre as pessoas que você observa, quem não deve aparecer para outras pessoas. Esta opção só se aplica quando sua lista estiver pública.', hiddenObservedEmpty: 'Você ainda não observa ninguém.', hiddenObservedSearch: 'Buscar por nome ou @usuário', hiddenObservedDialogTitle: 'Ocultar pessoas que você observa', hiddenObservedDialogHelp: 'Pesquise e selecione quem não deve aparecer na sua lista pública.', hiddenObservedNoResults: 'Nenhuma pessoa encontrada.',
    sex: 'Sexo', sexUnknown: 'Não informado', sexMale: 'Masculino', sexFemale: 'Feminino', changePhoto: 'Alterar foto', removePhoto: 'Remover foto de perfil', removePhotoTitle: 'Remover foto de perfil?', removePhotoHelp: 'Sua foto atual será removida e o avatar padrão voltará a aparecer.', removePhotoConfirm: 'Remover foto', photoRemoved: 'Foto removida.', enlargePhoto: 'Ampliar foto de perfil',
  ...
  home: {
    ...
    choosePhoto: 'Escolher foto', caption: 'Conte a história dessa foto', publish: 'Enviar publicação', uploading: 'Enviando foto…', processing: 'Processando imagem…', completed: 'Concluído', imageReady: 'Imagem pronta', uploadFailed: 'Falha no envio', publishing: 'Publicando…', publishingPhoto: 'Publicando sua foto…', loadingProfile: 'Carregando no perfil…', photoPublished: 'Foto publicada',
    ...
    deletePhoto: 'Apagar esta foto?', loadMore: 'Carregar mais', loadingMore: 'Carregando…', viewProfile: 'Ver perfil de', post: 'Postar', newPost: 'Publicar', fullscreenPhoto: 'Tela cheia', previousPhoto: 'Foto anterior', nextPhoto: 'Próxima foto', editCaption: 'Editar legenda', profilePhotos: 'Perfil', globalPhotos: 'Global', slideshow: 'Apresentação', pauseSlideshow: 'Pausar', slideshowInterval: 'Tempo', loopSlideshow: 'Loop',
