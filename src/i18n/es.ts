export default {
  ...
  home: {
    ...
    deletePhoto: '¿Eliminar esta foto?', loadMore: 'Cargar más', loadingMore: 'Cargando…', viewProfile: 'Ver perfil de', post: 'Publicar', newPost: 'Publicar imagen', fullscreenPhoto: 'Pantalla completa', previousPhoto: 'Foto anterior', nextPhoto: 'Foto siguiente', editCaption: 'Editar descripción',
