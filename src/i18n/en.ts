export default {
  ...
  home: {
    ...
    deletePhoto: 'Delete this photo?', loadMore: 'Load more', loadingMore: 'Loading…', viewProfile: 'View profile of', post: 'Post', newPost: 'Publish image', editCaption: 'Edit caption',
